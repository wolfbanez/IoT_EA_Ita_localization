...
>>> CURRENT LOCALIZED STABLE VERSION: 0.9.1 <<<

>>> CURRENT LOCALIZED EXPERIMENTAL VERSION: 0.9.1  <<<

HOW TO INSTALL Localization

1) Download localized files from GitHub
2) Go here: \IndustriesOfTitan\Titan\Content\TextData\
4) Copy the localized loc_it.csv into the directory, no need to rewrite any other files
4b) If updating the translation, simply overwrite the loc_it.csv
5) Run the game
